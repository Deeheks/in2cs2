...
class YSaveAllBakedImages(bpy.types.Operator):
    ...
    remove_whitespaces : BoolProperty(
        name = 'Remove Whitespaces',
        description = 'Remove whitespaces from baked image names',
        default = False
    )
    only_bake_targets : BoolProperty(
        name = 'Only bake Textures',
        description = 'Skips standalone channels',
        default = False
    )
