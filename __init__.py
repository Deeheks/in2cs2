bl_info = {
    "name": "in2cs2",
    "author": "Deeheks, Yusuf Umar, Agni Rakai Sahakarya, Jan Bláha, Ahmad Rifai, morirain, Patrick W. Crawford, neomonkeus, Kareem Haddad, passivestar, Przemysław Bągard",
    "version": (2, 4, 4),
    "blender": (2, 80, 0),
    "location": "Node Editor > Properties > in2cs2",
    "warning": "",
