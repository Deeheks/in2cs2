...
class YPaintPreferences(AddonPreferences):
    ...
    developer_mode : BoolProperty(
        name = 'Developer Mode',
        description = 'Developer mode will shows several menu intended for developer only',
        default = False
    )
    ...
    skip_property_popups : BoolProperty(
        ...
        description = 'Don\'t show property popups unless Shift key is pressed. Will use last invocation properties if skipped',
        default = False
    )
    ...
    enable_material_view_warning : BoolProperty(
        ...
        description = 'Enable warning popup when '+get_addon_title()+' parent window is not in a Material render/preview mode',
        default = True
    )
...
def auto_save_images(scene):
    ...
    for tree in bpy.data.node_groups:
        ...
        #except: print('EXCEPTION: Cannot save yp version!')
        #try: tree.yp.blender_version = get_current_blender_version_str()
        #except: print('EXCEPTION: Cannot save blender version!')
        #try: tree.yp.is_unstable = get_alpha_suffix() != ''
        #except: print('EXCEPTION: Cannot save unstable version flag!')
